...
/**
 * Returns the complete data store.
 *
 * @returns (Object) The complete key-value-store.
 *
 */
Store.prototype.getAll = function getAll (callback) {
    this.$$read(callback);
};
 ...
 * 
 */
exports.instantiate = function instantiate (file) {
